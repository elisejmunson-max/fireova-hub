...
export default function EventDetailPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="min-h-full bg-white px-4 pb-24 pt-2 md:px-8 md:pb-10 md:pt-4">
      <div className="mx-auto max-w-7xl">
        <Link href="/events" className="mb-3 inline-flex min-h-10 items-center gap-1 text-sm font-semibold text-stone-500 transition hover:text-stone-950 md:mb-4 md:min-h-0">
