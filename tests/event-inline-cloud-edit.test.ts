...
test('the complete labeled Event Details form is the default and only layout', () => {
  ...
  assert.match(inlineHeaderSource, /text-base font-semibold[\s\S]*?text-\[#171717\][\s\S]*?md:text-\[30px\]/)
  assert.match(inlineHeaderSource, /placeholder:text-base placeholder:font-normal placeholder:text-\[#78716C\]/)
