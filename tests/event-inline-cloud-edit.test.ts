...
test('the complete labeled Event Details form is the default and only layout', () => {
  ...
  assert.match(inlineHeaderSource, /cursor-pointer pl-12 pr-10 text-left/)
  ...
  assert.match(inlineHeaderSource, /relative order-1 min-w-0 overflow-hidden md:order-2 md:overflow-visible[\s\S]*?event-details-date/)
  assert.match(inlineHeaderSource, /appearance-none pr-10 md:appearance-auto md:pr-3/)
  assert.match(inlineHeaderSource, /max-w-full cursor-pointer pl-12 pr-10 text-left text-transparent \[min-inline-size:0\]/)
