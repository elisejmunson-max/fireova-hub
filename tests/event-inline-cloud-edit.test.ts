...
test('the complete labeled Event Details form is the default and only layout', () => {
  ...
  assert.match(inlineHeaderSource, /text-\[25px\] font-semibold[\s\S]*?text-\[#171717\][\s\S]*?md:text-\[30px\]/)
  assert.match(inlineHeaderSource, /placeholder:text-\[22px\] placeholder:font-normal placeholder:text-\[#78716C\]/)
